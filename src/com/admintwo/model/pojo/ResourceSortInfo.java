...
public class ResourceSortInfo {
	...
	public String toString() {
		return "ResourceSortInfo [sort=" + sort + ", id=" + id + ", name=" + name + ", nowtime=" + nowtime + ", isjing="
				+ isjing + ", isyuan=" + isyuan + ", res_comments_num=" + res_comments_num + ", res_download_num="
				+ res_download_num + ", res_keep_num=" + res_keep_num + "]";
	}
